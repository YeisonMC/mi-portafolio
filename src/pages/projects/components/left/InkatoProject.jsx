...
//? ICONOS SVG
import ProjectInkato from "@projects/inkato.svg";
...
const InkatoProject = () => {
  return (
    <div className="my-6">
      <div className="grid grid-cols-2 gap-6 max-lg:grid-cols-1 max-lg:gap-0 items-center max-lg:flex max-lg:flex-col-reverse">
        <div className="px-6 text-justify max-lg:py-4 max-lg:px-3 max-xl:my-auto">
          ...
          <p>
            Este proyecto, construido con React + Vite y Tailwind, es un landing
            page centrado en la temática de la arquitectura. Dentro de este
            landing page hay cuatro secciones con animaciones de desplazamiento,
            implementadas mediante AOS de GitHub. Se cuenta entre mis proyectos
            favoritos y está disponible para su visita en Vercel.
          </p>
        </div>
        <img
          src={ProjectInkato}
