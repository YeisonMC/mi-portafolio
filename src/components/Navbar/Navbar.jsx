...
import Instagram from "../../assets/images/redes/instagram.svg";
  ...
  return (
    <nav className="shadow-[rgba(0,_0,_0,_0.10)_0px_2px_10px]">
      <div className="flex justify-between items-center py-5 max-w-screen-2xl w-11/12 mx-auto ">
        ...
        <img src={LogoNameHead} alt="" className="w-[80px] z-20" />
      ...
      <div className={`md:hidden mobile-menu ${isOpen ? "open" : ""}`}>
        <div className="px-2 pt-2 space-y-1 flex flex-col  h-screen justify-around">
          <div className="space-y-10 flex flex-col items-center text-xl">
            <Link
              to="/"
              className={` ${NAV_LINK_CLASS} ${
                location.pathname === "/" ? "active" : ""
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <a
              ...
              target="_blank"
            >
              <img src={Instagram} alt="" className="w-[1.6em]" />
            </a>
          </div>
        </div>
      </div>
